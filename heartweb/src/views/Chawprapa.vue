...
<div>    
  ...
  <img class="home_icon_pu" alt="home_pu" src="../assets/logo1.svg">
    ...
    <div class="Header2">
        ...
        <div class="div_graph_pu">
          <apexchart class="graph_pu" type="line" height="250" ref="chart" :options="chartOptions" :series="series2"></apexchart>
        </div>
        <!-- <HrRateLine/> -->
...
var query2 = firebase.database().ref("wave2").orderByKey();
